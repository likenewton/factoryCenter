package cn.yunovo.iov.device.zen.biz.statistics.type.service.impl;
...
import cn.yunovo.iov.device.zen.biz.statistics.type.manager.StatisticsTypeManager;
...
public class StatisticsTypeServiceImpl implements StatisticsTypeService {
	...
	public StatisticsTypeDTO queryStatisticsType(StatisticsTypeQuery statisticsTypeQuery) {
		return statisticsTypeManager.queryStatisticsType(statisticsTypeQuery);
	}
	...
	public Integer deleteStatisticsType(StatisticsTypeDO statisticsTypeDO){
		return statisticsTypeManager.deleteStatisticsType(statisticsTypeDO);
	}
}
