package cn.yunovo.iov.device.zen.biz.statistics.sumtotal.manager;

import java.util.List;
import java.util.Date;
import java.util.Map;

import cn.yunovo.iov.device.zen.biz.statistics.sumtotal.mapper.StatisticsSumTotalMapper;
